...
init -1 python hide:
    ...
    config.window_title = u"Ace Attorney - The High School Years"
...
python early:
    config.save_directory = "AA - HY-1392424460"
...
init python:
    ...
    build.directory_name = "AA - HY-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "AA - HY"
